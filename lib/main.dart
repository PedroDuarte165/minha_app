      ...
      bottomNavigationBar: BottomNavigationBar(
          onTap: (value) async {
            switch (value) {
              ...
              case 1:
                ...
                break;
              case 2:
                bool res = await webView.canGoBack();
                if (res) {
                  webView.goBack();
                }
          ...
          items: [
            BottomNavigationBarItem(
                title: Text(""), icon: Icon(Icons.play_arrow)),
            BottomNavigationBarItem(title: Text(""), icon: Icon(Icons.pause)),
            BottomNavigationBarItem(
              title: Text(""),
...
class _MyAppState extends State<MyApp> {
  ...
  final list = [
    {
      ...
      "coverUrl": "assets/ic_launcher.jpg"
    },
    {
      "title": "network",
  ...
  void loadFile() async {
    ...
    final file = File("${appDocDir.path}/assets/audio.mp3");
    file.writeAsBytesSync(audio);

    AudioInfo info = AudioInfo("file://${file.path}",
        title: "file", desc: "local file", coverUrl: "assets/ic_launcher.jpg");
